...
public abstract class Edge {
    ...
    private static final Border borderTop = BorderFactory.createMatteBorder(5, 0, 0, 0, Color.BLACK);
    private static final Border borderLeft = BorderFactory.createMatteBorder(0, 5, 0, 0, Color.BLACK);
    private static final Border borderBottom = BorderFactory.createMatteBorder(0, 0, 5, 0, Color.BLACK);
    private static final Border borderRight = BorderFactory.createMatteBorder(0, 0, 0, 5, Color.BLACK);
	...
	public static Border getStandardBorder() {		
	    Border padrao = new CompoundBorder(StandardColor.getTop(), StandardColor.getBottom());
	    padrao = new CompoundBorder(padrao, StandardColor.getLeft());
	    padrao = new CompoundBorder(padrao, StandardColor.getRight());
	    return padrao;
	}
